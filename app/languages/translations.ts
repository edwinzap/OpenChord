export const languages = ['en_us', 'pt_br', 'fr_be'] as const;
...
const translations: Languages = {
  ...
  fr_be: {
    ...
    language_english_name: "French",
    language: 'Langue',
    settings: 'Options',
    playlists: 'Listes de lecture',
    artists: 'Artistes',
    online_search: 'Recherche en ligne',
    songs: 'Chansons',
    preview: 'Prévisualisation',
    add_songs: 'Ajouter des chansons',
    edit_song: 'Editer la chanson',
    edit: 'Editer',
    delete: 'Supprimer',
    go_to_online_search: 'Aller sur Recherche en ligne',
    go_to_artist: 'Voir l\'Artiste',
    share: 'Partager',
    create_new_playlist: 'Créer une nouvelle liste de lecture',
    you_havent_created_any_playlist_yet: "Tu n'as pas encore créé de liste de lecture",
    you_havent_downloaded_any_song_yet: "Tu n'as pas encore téléchargé de chanson",
    you_havent_added_any_song_to_this_playlist_yet: "Tu n'as pas encore ajouté de chanson à cette liste de lecture",
    search: 'Rechercher',
    create: 'Créer',
    playlist_name: 'Nom de la liste de lecture',
    playlist_edit: 'Editer la liste de lecture',
    create_backup: "Créer une sauvegarde",
    create_backup_description: "Rassembler toutes les chansons et listes de lecture dans un fichier .openchord",
    import: 'Importer',
    import_description: 'Sauvegardes, listes de lecture et fichiers .openchord',
    artist_name: 'Nom de l\'artiste',
    chords_over_lyrics: 'Accords au dessus des paroles',
    invalid_artist: 'Artiste invalide',
    ...
    page_turner: 'Tourneur de page',
    playlists_not_found: 'Listes de lecture introuvable',
    show_tabs: 'Montrer les tablatures',
    close: 'Fermer',
    info: 'Info',
    playlist_saved: 'Liste de lecture sauvegardée',
    share_message: 'Télécharger l\'app OpenChord, se rendre dans Options > Importer et selectionner ce fichier',
    empty_name_not_allowed: 'Un nom est requis',
    artist_or_song_not_found: 'Artiste ou chanson introuvable',
    permission_title: 'Permission de stockage de l\'app OpenChord',
    permission_message: 'L\'app OpenChord nécessite l\'accès au stockage afin d\enregistrée les sauvegardes',
    permission_button_positive: 'OK',
    permission_button_negative: 'Annuler',
    permission_denied: 'Accès en écriture au stockage refusé',
    success: 'Succès',
    backup_saved_at_path: 'Sauvegarde enregistrée dans',
    songs_imported_successfully: 'Chansons importées avec succès',
    song_downloaded: 'Chanson téléchargée',
    text_size: 'Taille du texte',
    show_tabs_by_default: 'Afficher les tablatures par défaut',
    hide_tabs_by_default: 'Cacher les tablatures par défaut',
    enable_page_turner_by_default: 'Activer le tourneur de page par défaut',
    disable_page_turner_by_default: 'Désactiver le tourneur de page par défaut',
    sort_by_title: 'Trier par titre',
    sort_by_artist: 'Trier par artiste',
    custom_sort: 'Tri personnalisé',
    developed_by: 'Développé par',
    home: 'Accueil',
    online_search_not_available: 'Désolé, la Recherche en ligne n\'est pas encore disponible sur iOS',
